         ...
         <div class="col-lg-12">
          ...
          <div class="col-xxl-4 col-md-12">
              <div class="card info-card sales-card">
                <div class="card-body">
                  <h5 class="card-title">Book Me <span>| As of Today</span></h5>
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ps-3">
                            <h6> 245 </h6>
                            <span class="text-success small pt-1 fw-bold">ADMIN</span> <span class="text-muted small pt-2 ps-1">VIEW</span>
                        </div>
                    </div>
                </div>
