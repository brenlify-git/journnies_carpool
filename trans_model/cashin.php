            ...
            <div class="card-body">
              ...
              <form class="row g-3" action="../process/cashin-process.php" method="post">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" id="contactNumber" placeholder="09770191818" pattern="09[0-9]{9}" maxlength="11" name="senderNum" required>
                </div>

                <div class="col-md-4">
                  <label class="col-sm-7 form-label">Amount <span class="require">*</span></label>
                  <div class="col-sm-12">
                    <select class="form-select" aria-label="Default select example" name="amount" required id="idType">
                ...
                <div class="text-center" style="margin-top: 30px;">
                  <button type="submit" class="btn btn-success col-md-3"><i class="bi bi-cash"></i>
          ...
          <div class="card">
            <div class="card-body">
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <h2 class="card-title">This table displays the history of your cash in transaction</h2>
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?= $tbl_bookinfo['transAmount'] -  $tbl_bookinfo['transConFee']; ?> </td>
                        </tr>
                      <?php
                        $x++;
                      endwhile;
